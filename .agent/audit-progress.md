...
| 6 | `update/navigation.rs` pending-expand dedup + paired tests/navigation.rs macro | 🟡 partial | Lanes A+B from `.agent/plans/pending-expand-dedup.md` (2026-05-09). Lane A (resolvers): `22c0871` `5599c87` `8137cbf` `6d38511` `3ea4a69`. Lane B (priming/handlers): `ca398fe` `52c57b0` `a58757d`. Lane C (test mirror macro) pending. |
...
|---:|---|---|---|
| 1 | Pending-expand × {Album, Artist, Genre, Song} dedup | 🟡 partial | Same as §7 #6 — Lanes A+B complete; Lane C pending. |
