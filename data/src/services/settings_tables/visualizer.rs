...
use crate::{
    ...
    types::{
        ...
        visualizer_config::{
            ...
            LinesGradientMode, LinesStyle, MilkdropPresetSource, MilkdropRenderQuality,
            VisualizerPlacement,
        },
    },
};
...
define_settings! {
    ...
    settings: [
        ...
        MilkdropPresetIntervalSecs {
            ...
            value_type: Int,
            setter: |mgr, v: i64| mgr.with_visualizer(|vz| vz.milkdrop.preset_interval_secs = u32::try_from(v).unwrap_or_default()),
            toml_apply: |_ts, _p| {},
            read: |_src, _out| {},
            write: |_ps, _ts| {},
            ui_meta: {
                label: "Preset Interval",
                category: "MilkDrop",
                subtitle: Some("Seconds before MilkDrop picks another preset. 0 keeps the current one until you press Next Preset."),
                default: i64::from(crate::types::visualizer_config::VisualizerConfig::default().milkdrop.preset_interval_secs),
                min: 0,
                max: 600,
                step: 5, unit: "s",
                read_field: |d| d.milkdrop_preset_interval_secs,
            },
        },
        MilkdropPresetCrossfadeSecs {
            key: "visualizer.milkdrop.preset_crossfade_secs",
            value_type: Float,
            setter: |mgr, v: f64| mgr.with_visualizer(|vz| vz.milkdrop.preset_crossfade_secs = v as f32),
            toml_apply: |_ts, _p| {},
            read: |_src, _out| {},
            write: |_ps, _ts| {},
            ui_meta: {
                label: "Preset Crossfade",
                category: "MilkDrop",
                subtitle: Some("Seconds one preset takes to dissolve into the next. 0 cuts straight to the new preset; longer blends are smoother but draw two presets at once while they last."),
                default: f64::from(crate::types::visualizer_config::VisualizerConfig::default().milkdrop.preset_crossfade_secs),
                min: 0.0,
                max: 10.0,
                step: 0.5, unit: "s",
                read_field: |d| d.milkdrop_preset_crossfade_secs,
            },
        },
        MilkdropSwitchOnTrackChange {
            key: "visualizer.milkdrop.switch_on_track_change",
            value_type: Bool,
            setter: |mgr, v: bool| mgr.with_visualizer(|vz| vz.milkdrop.switch_on_track_change = v),
            toml_apply: |_ts, _p| {},
            read: |_src, _out| {},
            write: |_ps, _ts| {},
            ui_meta: {
                label: "Change Preset With Track",
                category: "MilkDrop",
                subtitle: Some("On: each new track brings a new preset. Off: presets change only on the timer and the keys."),
                default: crate::types::visualizer_config::VisualizerConfig::default().milkdrop.switch_on_track_change,
                read_field: |d| d.milkdrop_switch_on_track_change,
            },
        },
        MilkdropPresetSourceRow {
            key: "visualizer.milkdrop.preset_source",
            value_type: Enum,
            setter: |mgr, v: String| mgr.with_visualizer(|vz| vz.milkdrop.preset_source = MilkdropPresetSource::from_wire_str(&v)),
            toml_apply: |_ts, _p| {},
            read: |_src, _out| {},
            write: |_ps, _ts| {},
            ui_meta: {
        ...
        MilkdropRenderQualityRow {
            key: "visualizer.milkdrop.render_quality",
            value_type: Enum,
            setter: |mgr, v: String| mgr.with_visualizer(|vz| vz.milkdrop.render_quality = MilkdropRenderQuality::from_wire_str(&v)),
            toml_apply: |_ts, _p| {},
            read: |_src, _out| {},
            write: |_ps, _ts| {},
            ui_meta: {
                ...
                category: "MilkDrop",
                subtitle: Some("Pixels MilkDrop renders on the shorter side of the panel before scaling\nlow: 480, soft and cheap\nmedium: 720\nhigh: 1080\nnative: pixel-exact, costs the most on a big window"),
                default: crate::types::visualizer_config::VisualizerConfig::default().milkdrop.render_quality.as_wire_str(),
                options: MilkdropRenderQuality::all_wire_strs(),
                read_field: |d| d.milkdrop_render_quality.as_ref(),
            },
        },
        MilkdropShowPresetNames {
            key: "visualizer.milkdrop.show_preset_names",
            value_type: Bool,
            setter: |mgr, v: bool| mgr.with_visualizer(|vz| vz.milkdrop.show_preset_names = v),
            toml_apply: |_ts, _p| {},
            read: |_src, _out| {},
            write: |_ps, _ts| {},
            ui_meta: {
                ...
                category: "MilkDrop",
                subtitle: Some("On: each preset change shows its name in a toast. Off: presets change silently."),
                default: crate::types::visualizer_config::VisualizerConfig::default().milkdrop.show_preset_names,
                read_field: |d| d.milkdrop_show_preset_names,
            },
        },
    ]
}
