...
define_hotkey_actions! {
    configurable: [
        ...
        NextVisualizerPreset {
            display: "Next Preset",
            description: "MilkDrop: jump to another preset",
            category: "Playback",
            toml_key: "next_visualizer_preset",
            settings_key: "hotkey.next_preset",
            default: KeyCombo::key(KeyCode::Char('n')),
        },
        PreviousVisualizerPreset {
            display: "Previous Preset",
            description: "MilkDrop: go back to the preset before this one",
            category: "Playback",
            toml_key: "previous_visualizer_preset",
            settings_key: "hotkey.previous_preset",
            default: KeyCombo::key(KeyCode::Char('p')),
        },
        ToggleVisualizerPresetLock {
            display: "Lock Preset",
            description: "MilkDrop: keep the current preset until unlocked",
            category: "Playback",
            toml_key: "toggle_visualizer_preset_lock",
