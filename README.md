...
**Platform:** Linux only. Built and tested on Arch Linux (Wayland/Hyprland) with PipeWire v<!-- pipewire-version -->1.6.7<!-- /pipewire-version --> and Navidrome v<!-- navidrome-version -->0.63.2<!-- /navidrome-version -->. No Windows or macOS support.
