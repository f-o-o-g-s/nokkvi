...
*Demo showcasing Nokkvi's GPU-accelerated audio visualizers and instant theme hot-reloading in action.*
...
**Platform:** Linux only. Built and tested on Arch Linux (Wayland/Hyprland) with PipeWire v<!-- pipewire-version -->1.6.5<!-- /pipewire-version --> and Navidrome v<!-- navidrome-version -->0.61.2<!-- /navidrome-version -->. No Windows or macOS support.
