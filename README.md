...
**Platform:** Linux only. Built and tested on Arch Linux (Wayland/Hyprland) with PipeWire v<!-- pipewire-version -->1.6.6<!-- /pipewire-version --> and Navidrome v<!-- navidrome-version -->0.62.0<!-- /navidrome-version -->. No Windows or macOS support.
