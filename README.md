...
**Platform:** Linux only. Built and tested on Arch Linux (Wayland/Hyprland) with PipeWire v<!-- pipewire-version -->1.6.9<!-- /pipewire-version --> and Navidrome v<!-- navidrome-version -->0.64.1<!-- /navidrome-version -->. No Windows or macOS support.
