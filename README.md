...
**Platform:** Linux only. Tested on Arch Linux with PipeWire v<!-- pipewire-version -->1.6.3<!-- /pipewire-version --> and Hyprland v<!-- hyprland-version -->0.54.3<!-- /hyprland-version --> against Navidrome v<!-- navidrome-version -->0.61.1<!-- /navidrome-version -->. No Windows or macOS support.
