...
- **The night sky's rarest event: a spiral galaxy.** Every once in a long while a faint spiral swirl materializes in the open night sky and draws the whole constellation into itself — stars stream inward along tightening spiral paths, hold a breath at the core, then glide back home as the swirl dissolves. The moon just watches, and shooting stars sit those cycles out.
