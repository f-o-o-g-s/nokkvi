...
- **The moon dreams.** Once when the app opens, and rarely after that, the Trawl scene's moon slips into a short ritual: its face lets go, mark by mark, and four verses in carved staves drift through the sky, each one calling a mark back — the grin first. What the staves say is left to whoever cares to read them. The black hole, the shooting star, and the wandering notes sit those cycles out; the sun, being the same face, dreams too.
