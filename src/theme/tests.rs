//! Shared regression tests for the theme module — contrast math, highlight
//! fills, strip banding, radius gating, and the atomic_u8_enum round-trips.
...
use super::*;
use crate::{
    atomic_u8_enum::AtomicU8Enum,
    theme_config::{ResolvedDualTheme, ResolvedTheme},
};
