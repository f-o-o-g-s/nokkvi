...
// SettingValue moved to `nokkvi_data::types::setting_value` so the macro-
// generated dispatch tables in `data/src/services/settings_tables/` can
// reference it. Re-exported here so existing `crate::views::settings::items::SettingValue`
// import paths keep resolving.
pub(crate) use nokkvi_data::types::setting_value::SettingValue;
