...
use crate::{
    app_message::Message,
    widgets::{
        self, SlotListPageMessage, SlotListPageState, slot_list_page::SlotListPageAction,
        view_header::SortMode,
    },
};
...
impl RadiosPage {
    ...
    pub fn view<'a>(&'a self, data: RadiosViewData<'a>) -> Element<'a, RadiosMessage> {
        ...
        let header = widgets::view_header::view_header(
            ...
            |m| RadiosMessage::SlotList(SlotListPageMessage::SortModeSelected(m)),
            Some(RadiosMessage::SlotList(
            ...
            true,                                                  // show_search
            |q| RadiosMessage::SlotList(SlotListPageMessage::SearchQueryChanged(q)),
