# Changelog — v0.6.x archive

Releases v0.6.0 through v0.6.10, covering 2026-05-25 to 2026-06-06. The current changelog (v0.7.0 onward) lives in [CHANGELOG.md](../CHANGELOG.md).
